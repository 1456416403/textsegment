...
def zero_state(module, batch_size):
    ...
    return torch.tensor(maybe_cuda(torch.zeros(module.num_layers * 2, batch_size, module.hidden))), \
           torch.tensor(maybe_cuda(torch.zeros(module.num_layers * 2, batch_size, module.hidden)))
...
class Model(nn.Module):
    ...
    def forward(self, batch):
        ...
        unsort_order = torch.tensor(maybe_cuda(torch.LongTensor(unsort(sort_order))))
